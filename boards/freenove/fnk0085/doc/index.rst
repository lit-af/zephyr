.. zephyr:board:: fnk0085

Overview
********

The FNK0085 is an entry-level development board equipped with an ESP32-S3-WROOM-1 with either 8MB or 16MB flash and 8 MB PSRAM. This board integrates complete Wi-Fi
and Bluetooth Low Energy functions. For more information, check `FNK0085`_.
...
FNK0085 includes the following features:
...
ESP32S3 allows 2 different applications to be executed in ESP32-S3 SoC. Due to its dual-core
...
.. _`FNK0085`: https://github.com/Freenove/Freenove_ESP32_S3_WROOM_Board
